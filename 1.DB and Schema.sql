...
-- Loaded CSVs into initial and delta Folders -- File Load UI Method
-- validate the Files in Stage.

-- All files
list @STAGE_SCH.CSV_STG;


-- Only Initial Folder Files
LIST @STAGE_SCH.CSV_STG/initial;


-- Query Files in Stage -- without Loading in tables
-- FILE FORMAT Helps SNOWFLAKE knows exactly how to parse and structure the raw, unorganized text data into rows and columns
